      ...
      <el-col :xs="15" :sm="18" :md="19" :lg="20" :xl="20">
        ...
        <el-dialog append-to-body :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="570px">
          <el-form ref="form" :inline="true" :model="form" :rules="rules" size="small" label-width="66px">
            ...
            <el-form-item label="党派" prop="dept.id">
              <treeselect
            ...
            <el-form-item label="部门" prop="jobs">
              <el-select
                v-model="form.jobs"
                style="width: 178px"
                multiple
        ...
        <el-table ref="table" v-loading="crud.loading" :data="crud.data" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
          ...
          <el-table-column :show-overflow-tooltip="true" prop="nickName" label="昵称" width="120" />
          <el-table-column prop="roles[0].name" label="角色" width="125" />
          <el-table-column prop="gender" label="性别" width="90" />
          <el-table-column :show-overflow-tooltip="true" prop="phone" label="电话" />
          <el-table-column :show-overflow-tooltip="true" prop="dept" label="院系">
...
let userRoles = []
let userJobs = []
const defaultForm = { id: null, username: null, nickName: null, gender: '男', roles: [], jobs: [], enabled: 'false', dept: { id: null }, phone: null }
export default {
  name: 'User',
  ...
  methods: {
    getUserStatusLabel(val) {
      for (let i = 0; i < this.user_status.length; i++) {
        if (this.user_status[i].value === val) {
    ...
    changeEnabled(data, val) {
      this.$confirm('此操作将 "' + this.getUserStatusLabel(val) + '" ' + data.username + ', 是否继续？', '提示', {
        ...
        crudUser.edit(data).then(res => {
          this.crud.notify('禁用成功', CRUD.NOTIFICATION_TYPE.SUCCESS)
        }).catch(() => {
